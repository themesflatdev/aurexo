    ...
    function mainMap() {
      ...
      function locationData(
        ...
        return (
          ...
          '<p class="location">' + '<img src="./assets/icons/icon-gauge.svg" alt="gauge">' +
          locationTopCity +
          "</p>" +
          '<p class="location">' + '<img src="./assets/icons/calendar.svg" alt="calendar">' +
          locationTopCity2 +
          "</p>" +
      ...
      var locations = [
        [
          locationData(
            "assets/images/card/card-44.jpg",
            "listing-detail.html",
          ...
          -74.006821,
          1,
          '<p class="mark-price">$44.900</p>',
        ],  
        [
          locationData(
            "assets/images/card/card-45.jpg",
            "listing-detail.html",
          ...
          -74.00423,
          2,
          '<p class="mark-price">$40.900</p>',
        ], 
        [
          locationData(
            "assets/images/card/card-46.jpg",
            "listing-detail.html",
            "Kia EV9 2024",
            "32500 miles",
            "2022",
        ...
        google.maps.event.addDomListener(
          ...
          (function (overlay, i) {
            return function (e) {
              ...
              // Xóa class clicked từ tất cả markers
              $(".map-marker-container").removeClass("clicked infoBox-opened");
              
              // Thiết lập nội dung và mở popup mới
              ib.setOptions(boxOptions);
              boxText.innerHTML = locations[i][0];
              ib.open(map, overlay);
              currentInfobox = locations[i][3];
              
              // Thêm class để đánh dấu marker đang được chọn
              if (overlay.div) {
                $(overlay.div).addClass("clicked infoBox-opened");
              }
              
              // Xử lý sự kiện domready của InfoBox để thêm event listener cho nút close
              google.maps.event.addListenerOnce(ib, "domready", function () {
                // Tìm và thêm event listener cho nút close trong InfoBox
                var closeBtn = boxText.querySelector(".infoBox-close");
                if (closeBtn) {
    ...
    CustomMarker.prototype.draw = function () {
      ...
      if (!div) {
        ...
        google.maps.event.addDomListener(div, "click", function (event) {
          ...
          // Trigger click event để xử lý mở popup
